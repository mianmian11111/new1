...
from textattack.models.wrappers.huggingface_model_mask_ensemble_wrapper import HuggingFaceModelMaskEnsembleWrapper
import lru
...
class Attack:
    ...
    def attack_dataset(self, dataset, indices=None):
        ...
        #HuggingFaceModelMaskEnsembleWrapper().zhi_0()
        for goal_function_result in examples:
            if goal_function_result.goal_status == GoalFunctionResultStatus.SKIPPED:
                ...
                yield result
            a=0
            self.goal_function.model.nums=a
