...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.layer_weights = nn.Parameter(torch.tensor([0.0459, 0.0432, 0.0426, 0.0403, 0.0396, 0.0372, 0.0384, 0.0379, 0.0453,0.2868, 0.1900, 0.1528], dtype=torch.float))# 层权重初始化为全1
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, labels=None,
        ...
        # 加权平均
        pooled_output = torch.sum(layer_means * self.layer_weights.unsqueeze(1).unsqueeze(2), dim=0)
